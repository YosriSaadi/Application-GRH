    ...
    subItems: [
        {
            id: 74,
            label: 'Départements',
            link: '/configuration/départements',
            parentId: 70
        },
        {
            id: 75,
            label: 'Statues',
            link: '/configuration/statues',
            parentId: 70
        },
        {
            id: 76,
            label: 'Congés',
            link: '/configuration/congés',
            parentId: 70
        },
        {
            id: 77,
            label: 'Prêts',
            link: '/configuration/prêts',
            parentId: 70
        },
        {
            id: 78,
            label: 'Primes',
            link: '/configuration/primes',
            parentId: 70
        },
    ]
},
...
},
{
    ...
    subItems: [
        {
            id: 78,
            label: 'Grilles Des Salaires',
            link: '/legislation/grille',
            parentId: 73
        },
        {
            id: 79,
