...
export class TopbarComponent implements OnInit {
  ...
  constructor(@Inject(DOCUMENT) private document: any, private router: Router, private authService: AuthenticationService, private authFackservice: AuthfakeauthenticationService, public languageService: LanguageService, public cookiesService: CookieService) { 
    ...
    if(this.authFackservice.currentadminValue!=null){
      this.nom=this.authFackservice.currentadminValue.nom+ " "+this.authFackservice.currentadminValue.prenom;
    }else{
      this.nom=this.authFackservice.currentUserValue.nom+ " "+this.authFackservice.currentUserValue.prenom;
    }
   ...
   */
  logout() {
    const currentAdmin = this.authFackservice.currentadminValue; 
    if(currentAdmin){

      this.authFackservice.logoutadmin();
