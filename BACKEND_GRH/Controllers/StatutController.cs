...
{
    public class StatutController : ApiController
    {

        [Route("statut_add")]
        [HttpPost]
        public IHttpActionResult addshift([FromBody] GRH_TYPE_STATUT r)
        {
            try
            {
        ...
        [Route("statut_update")]
        [HttpPut]
        public IHttpActionResult updateshift([FromBody] GRH_TYPE_STATUT r)
        {
            try
            {
                SqlConnection myConnection = new SqlConnection();
                ...
                SqlCommand sqlCmd = new SqlCommand();
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.CommandText = "statut_update";
                sqlCmd.Connection = myConnection;
                myConnection.Open();
                sqlCmd.Parameters.AddWithValue("@code", r.code);
                sqlCmd.Parameters.AddWithValue("@designation", r.designation);
        ...
        public HttpResponseMessage Getshiftbyid(String code)
        {
            ...
            using (var cmd = new SqlCommand("statut_getbyid", con))
        ...
        public IHttpActionResult deleteshiftbyid(string id)
        {
            ...
            SqlCommand sqlCmd = new SqlCommand();
            sqlCmd.CommandType = CommandType.StoredProcedure;
            sqlCmd.CommandText = "statut_delete";
